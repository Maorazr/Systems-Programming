...
public abstract class MicroService implements Runnable {
    ...
    private Map<Class<? extends Message>, Callback> msgCallbackMap;
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                Callback callback = msgCallbackMap.get(msg.getClass());
                callback.call(msg);
           } catch (Exception e){
                // e.printstackbullshit;
           }
        }
