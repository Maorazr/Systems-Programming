...
//                                    + "****************************************************************************************" );
                        ...
                        gpu.setBusy(false);
                        System.out.println( gpu.getName() + " just finished to train model " + gpu.getModel().getName() + "\n" + "model Stat = " + gpu.getModel().getStatus() + "\n"
                                + "****************************************************************************************" );
                    }
                }
            } else {
...
//                                + "currTick = " + currTick + "\n" + "****************************************************************************************" );
                            ...
                            System.out.println( gpu.getName() + " Tested a model, model Stat = " + gpu.getModel().getStatus()
                                    + "\n" + "" +
                                    "****************************************************************************************" );
